...
const HomePage = () => {
  ...
  return (
    <>
      ...
      <div className="hidden md:flex fixed left-0 top-1/2 -translate-y-1/2 z-50 flex-col items-start">
        ...
        >
          <div className="w-10 h-10 flex items-center justify-center">
            <svg className="w-4 h-4 text-stone-300 group-hover:text-gray-100" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
            </svg>
          </div>
          <span className="max-w-0 overflow-hidden group-hover:max-w-[80px] transition-all duration-300 text-[11px] font-bold uppercase tracking-widest text-gray-100 whitespace-nowrap pr-0 group-hover:pr-3">Call</span>
        </a>
        ...
        >
          ...
          <span className="max-w-0 overflow-hidden group-hover:max-w-[80px] transition-all duration-300 text-[11px] font-bold uppercase tracking-widest text-gray-100 whitespace-nowrap pr-0 group-hover:pr-3">Email</span>
        </a>
        ...
        >
          <div className="w-10 h-10 flex items-center justify-center">
            <svg className="w-4 h-4 text-stone-300 group-hover:text-gray-100" fill="currentColor" viewBox="0 0 24 24">
          ...
          <span className="max-w-0 overflow-hidden group-hover:max-w-[80px] transition-all duration-300 text-[11px] font-bold uppercase tracking-widest text-gray-100 whitespace-nowrap pr-0 group-hover:pr-3">WhatsApp</span>
        </a>
        ...
        <a
          ...
          rel="noopener noreferrer"
          title="Instagram"
          className="group flex items-center bg-color-secondary-dark hover:bg-primary transition-colors duration-200"
        >
          <div className="w-10 h-10 flex items-center justify-center">
            <svg className="w-4 h-4 text-stone-300 group-hover:text-gray-100" fill="currentColor" viewBox="0 0 24 24">
          ...
          <span className="max-w-0 overflow-hidden group-hover:max-w-[80px] transition-all duration-300 text-[11px] font-bold uppercase tracking-widest text-gray-100 whitespace-nowrap pr-0 group-hover:pr-3">Instagram</span>
        </a>
      </div>
      ...
      {/* Caption 2 */}
      <CaptionStrip
        backgroundUrl="https://kairafabrics.s3.ap-south-1.amazonaws.com/site/banner/v1/banner1.webp"
