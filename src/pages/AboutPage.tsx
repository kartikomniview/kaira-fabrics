          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-10">
            <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center">
              ...
              <div className={`transition-all duration-700 ${introVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
                <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-3 py-1 shadow-sm mb-5">
              ...
              <div className={`space-y-5 transition-all duration-700 delay-150 ${introVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
                ...
                <div className="flex items-start gap-3 p-5 bg-white border border-stone-200 rounded-2xl shadow-sm">
          ...
          <div className="relative z-10 max-w-5xl mx-auto px-6 lg:px-10">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              {[
                ...
                <div
                  key={i}
                  className={`border border-secondary-light/30 p-7 rounded-2xl hover:border-primary/50 transition-all duration-500 group ${philosophyVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}
                  style={{ transitionDelay: philosophyVisible ? `${i * 120}ms` : '0ms' }}
                >
                  <span className="font-serif text-4xl text-secondary-light/60 group-hover:text-primary/60 transition-colors duration-300 block mb-4">{item.label}</span>
        ...
        <section ref={pillarsRef} className="border-b border-stone-200 py-14 md:py-24 relative overflow-hidden">
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
            <div className={`text-center mb-10 md:mb-14 transition-all duration-700 ${pillarsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              <div className="inline-flex items-center gap-2 bg-primary/10 border border-primary/20 rounded-full px-3 py-1 shadow-sm mb-4">
                <span className="w-1.5 h-1.5 rounded-full bg-primary" />
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 md:gap-6">
              {pillars.map((pillar, index) => (
                <div
                  key={index}
                  className={`group bg-white border border-stone-200 p-7 rounded-2xl hover:bg-secondary hover:border-secondary transition-all duration-500 relative overflow-hidden shadow-sm ${pillarsVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
                ...
                >
                  ...
                  <div className="w-10 h-10 rounded-xl bg-stone-100 group-hover:bg-secondary-dark flex items-center justify-center text-stone-600 group-hover:text-primary transition-all duration-300 mb-5">
                    {pillar.icon}
                  </div>
          ...
          <div className="relative z-10 max-w-6xl mx-auto px-6 lg:px-10">
            <div className="grid md:grid-cols-[1fr_2fr] gap-10 md:gap-16 items-start">
              ...
              <div className={`transition-all duration-700 ${storyVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
                ...
                {/* Heritage badge */}
                <div className="bg-secondary text-white p-7 rounded-2xl inline-block w-full max-w-xs border border-secondary-dark/40">
              ...
              <div className={`space-y-6 transition-all duration-700 delay-150 ${storyVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
                ...
                <div className="bg-white border border-stone-200 rounded-2xl p-6 shadow-sm">
                  <div className="flex items-start gap-4">
                    <div className="shrink-0 w-1 self-stretch bg-primary rounded-full" />
                    <p className="font-serif text-xl md:text-2xl text-stone-800 leading-snug">
        ...
        <section className="bg-stone-900 py-14 md:py-16 border-b border-stone-800 relative overflow-hidden">
          ...
          <div className="relative max-w-7xl mx-auto px-6 lg:px-10 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 shrink-0 w-full md:w-auto">
              <Link
                to="/collections"
                className="group inline-flex items-center justify-center gap-3 px-10 py-4 md:px-12 md:py-5 bg-primary text-stone-900 hover:bg-white transition-all duration-500 rounded-xl overflow-hidden shadow-lg font-bold text-xs md:text-sm uppercase tracking-widest w-full sm:w-auto"
              >
                Browse Collections
              ...
              <Link
                to="/contact"
                className="inline-flex items-center justify-center gap-3 px-10 py-4 md:px-12 md:py-5 border border-stone-700 text-stone-300 hover:border-primary hover:text-white transition-all duration-300 rounded-xl font-bold text-xs md:text-sm uppercase tracking-widest w-full sm:w-auto"
              >
                Contact Us
              </Link>
            </div>
