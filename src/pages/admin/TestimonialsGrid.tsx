...
const TestimonialsGrid = ({ items, loading, error, onRefresh }: Props) => {
  ...
  const openEdit = (item: GalleryItem) => {
    ...
    setExistingThumbnailUrl(`https://kairafabrics.s3.ap-south-1.amazonaws.com/thumbnails/Testimonial/${videoNameNoExt}.webp`)
  }
  ...
  const handleThumbnailUpload = async () => {
    ...
    try {
      ...
      const asset_s3_key = 'thumbnails/Testimonial'
