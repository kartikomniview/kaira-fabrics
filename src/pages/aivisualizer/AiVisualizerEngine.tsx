...
import { useAiGenerationFlow, OTP_VALIDATION_ENABLED, DEFAULT_GENERATION_LIMIT } from './useAiGenerationFlow'

export const AI_VISUALIZER_PRODUCTS = [
...
const AiVisualizerEngine = () => {
  ...
  const handleSelectProduct = (p: typeof AI_VISUALIZER_PRODUCTS[number]) => {
    setSelectedProduct({
      id: p.productName,
        ...
        <div className="w-full bg-white shadow-2xl border border-stone-200 overflow-hidden flex flex-col lg:flex-row min-h-[600px] mt-6 lg:mt-8 mb-8 lg:mb-0">
          ...
          <div className="w-full lg:w-[55%] flex flex-col bg-white/60 overflow-hidden">
            ...
            <div className="flex-1 flex flex-col p-6 sm:p-10 overflow-y-auto min-h-0">
              ...
              {/* Step 2.5: Review Selected Product & Generate */}
              {currentStep === 2.5 && (
              ...
              {/* Step 3: Result */}
              {currentStep === 3 && (
                <div className="flex flex-col items-center gap-3 sm:gap-4 animate-in fade-in">
...
export default AiVisualizerEngine
