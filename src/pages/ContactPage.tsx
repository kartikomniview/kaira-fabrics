        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid lg:grid-cols-[1fr_420px] gap-14 xl:gap-20 items-start">
              ...
              {submitted ? (
                <div className="relative text-center py-20 border border-primary/30 bg-primary/5 overflow-hidden shadow-sm rounded-sm">
                  ...
                  <div className="relative">
                    <div className="w-16 h-16 border-2 border-primary mx-auto flex items-center justify-center mb-6 bg-[#5b4c2f] rounded-sm">
                      <svg className="w-7 h-7 text-primary" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                      </svg>
                    </div>
                    <h2 className="font-serif text-3xl text-[#5b4c2f] mb-3">Message Received</h2>
                    ...
                    <button
                      ...
                      className="group relative inline-flex items-center justify-center gap-3 px-8 py-3 bg-[#5b4c2f] text-white hover:bg-primary hover:text-[#5b4c2f] transition-all duration-500 rounded-sm overflow-hidden"
                    >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div className="group">
                      ...
                      <input
                        ...
                        className="w-full border border-stone-200 bg-white px-4 py-3 text-sm text-[#5b4c2f] placeholder:text-stone-300 focus:outline-none focus:border-[#5b4c2f] focus:ring-1 focus:ring-[#5b4c2f] transition-all rounded-sm shadow-sm"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      className="w-full border border-stone-200 bg-white px-4 py-3 text-sm text-[#5b4c2f] placeholder:text-stone-300 focus:outline-none focus:border-[#5b4c2f] focus:ring-1 focus:ring-[#5b4c2f] transition-all resize-none rounded-sm shadow-sm"
                  ...
                  <button
                    type="submit"
                    className="group relative inline-flex w-full items-center justify-center gap-3 px-8 py-4 bg-[#5b4c2f] text-white hover:bg-primary hover:text-[#5b4c2f] transition-all duration-500 overflow-hidden disabled:opacity-70 disabled:cursor-not-allowed"
                    disabled={loading}
                  >
            ...
            <aside className="space-y-6">
              ...
              {/* Contact Info Card */}
              <div
                className="relative text-white p-8 overflow-hidden rounded-sm shadow-md"
                style={{ backgroundColor: '#5b4c2f' }}
              >
                {/* top accent bar */}
                <span className="absolute top-0 left-0 w-full h-[3px] bg-primary" />
                {/* subtle bottom fade */}
                <span className="absolute bottom-0 left-0 w-full h-24 pointer-events-none" style={{ background: 'linear-gradient(to top, rgba(0,0,0,0.18), transparent)' }} />

                <div className="relative">
                  {/* brand mark */}
                  <div className="flex items-center gap-4 mb-8 pb-6 border-b border-white/10">
                    <div className="w-10 h-10 border border-primary/70 bg-white/5 flex items-center justify-center rounded-sm">
                    ...
                    <div>
                      ...
                      <p className="text-primary text-[10px] tracking-[0.25em] uppercase font-semibold mt-1.5 opacity-90">Calicut Showroom</p>
                    </div>
                  </div>

                  <div className="space-y-5">
                    <div className="flex gap-4 items-start">
                      <div className="flex-shrink-0 w-9 h-9 bg-white/10 border border-white/15 flex items-center justify-center mt-0.5 rounded-sm">
                        <svg className="w-4.5 h-4.5 text-primary w-[18px] h-[18px]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="flex gap-4 items-start">
                      ...
                      <div>
                        <p className="text-primary text-[10px] font-bold tracking-[0.2em] uppercase leading-none mb-2">Email</p>
                        <a href="mailto:info@kairafabrics.in" className="text-stone-100 text-sm hover:text-primary transition-colors">info@kairafabrics.in</a>
                      </div>
                    </div>
              ...
              <a
                ...
                className="flex items-center gap-3 w-full bg-primary hover:bg-primary/90 text-white px-6 py-4 transition-colors group rounded-sm shadow-sm"
              >
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="mt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="group relative inline-flex items-center justify-center gap-2 px-6 py-3 bg-[#5b4c2f] text-white hover:bg-primary hover:text-[#5b4c2f] transition-all duration-300 rounded-sm overflow-hidden"
            >
