        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
          ...
          <div className="grid lg:grid-cols-[1fr_420px] gap-14 xl:gap-20 items-start">
            ...
            <div>
              ...
              {submitted ? (
                <div className="relative text-center py-20 border border-primary/30 bg-primary/5 overflow-hidden shadow-sm">
                  {/* weave overlay */}
                  <div className="absolute inset-0 opacity-20" style={{ backgroundImage: weaveBg }} />
                  <div className="relative">
                    <div className="w-16 h-16 border-2 border-primary mx-auto flex items-center justify-center mb-6 bg-[#5b4c2f]">
                    ...
                    <button
                      ...
                      className="group relative inline-flex items-center justify-center gap-3 px-8 py-3 bg-[#5b4c2f] text-white hover:bg-primary hover:text-[#5b4c2f] transition-all duration-500 overflow-hidden"
                    >
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid sm:grid-cols-2 gap-6">
                    <div className="group">
                      ...
                      <input
                        ...
                        className="w-full border border-stone-200 bg-white px-4 py-3 text-sm text-[#5b4c2f] placeholder:text-stone-300 focus:outline-none focus:border-[#5b4c2f] focus:ring-1 focus:ring-[#5b4c2f] transition-all shadow-sm"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      className="w-full border border-stone-200 bg-white px-4 py-3 text-sm text-[#5b4c2f] placeholder:text-stone-300 focus:outline-none focus:border-[#5b4c2f] focus:ring-1 focus:ring-[#5b4c2f] transition-all resize-none shadow-sm"
                      placeholder="Tell us about your project, fabric requirements or enquiry…"
                    />
                  </div>

                  {error && (
                    <p className="text-red-600 text-[11px] font-medium border border-red-200 bg-red-50 px-4 py-3 shadow-sm">{error}</p>
                  )}
            ...
            <aside className="space-y-6">
              ...
              {/* Contact Info Card */}
              <div
                className="relative text-white p-8 overflow-hidden shadow-md"
              ...
              >
                ...
                <div className="relative">
                  ...
                  <div className="flex items-center gap-4 mb-8 pb-6 border-b border-white/10">
                    <div className="w-10 h-10 border border-primary/70 bg-white/5 flex items-center justify-center">
