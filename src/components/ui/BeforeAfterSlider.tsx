...
export function BeforeAfterSlider() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative w-full overflow-hidden shadow-[0_24px_64px_-12px_rgba(0,0,0,0.18)] select-none cursor-col-resize"
    ...
    >
      ...
      {/* Drag handle */}
      <div
        className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-10 h-10 bg-white shadow-[0_2px_16px_rgba(0,0,0,0.28)] flex items-center justify-center z-10 touch-none"
        style={{ left: `${pos}%` }}
