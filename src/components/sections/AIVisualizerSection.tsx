...
const AIVisualizerSection = () => {
  ...
  return (
    <section className="bg-stone-950 text-white py-16 lg:py-20 overflow-hidden border-y border-stone-800">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        <div className="grid lg:grid-cols-2 gap-12 xl:gap-20 items-center">
          ...
          <div>
            <p className="text-[10px] uppercase tracking-[0.25em] text-stone-600 mb-3">New Feature</p>
            <h2 className="font-serif text-3xl md:text-4xl lg:text-[42px] text-white leading-[1.15] mb-5">
              Visualize Fabrics<br />
              <span className="text-[#C5A552]">In Your Space</span>
            </h2>
            <p className="text-stone-400 text-sm leading-relaxed mb-10 max-w-[420px]">
            ...
            <div className="space-y-5 mb-10">
              {features.map((f, i) => (
                <div key={i} className="flex items-start gap-4">
                  <div className="shrink-0 mt-0.5 w-7 h-7 rounded-full border border-[#C5A552]/30 bg-[#C5A552]/10 flex items-center justify-center">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#C5A552]" />
                  </div>
                  <div>
                    <p className="text-white text-sm font-semibold tracking-wide">{f.label}</p>
          ...
          <div className="relative">
            ...
            <div className="rounded-2xl border border-stone-700/60 overflow-hidden shadow-[0_32px_80px_rgba(0,0,0,0.6)] bg-stone-900">
              ...
              <div className="bg-stone-800/70 border-t border-stone-700/50 px-3.5 py-2.5 flex items-center gap-2">
