...
const CTASection = () => {
  return (
    <section className="bg-stone-900 py-20 md:py-32 relative overflow-hidden border-t border-stone-800">
      ...
      <div className="relative max-w-4xl mx-auto px-6 lg:px-10 text-center z-10">
        ...
        <div className="inline-flex items-center justify-center gap-4 mb-8">
          ...
          <span className="text-[10px] sm:text-xs uppercase tracking-[0.3em] text-primary font-bold">Start Your Journey</span>
          <span className="h-px w-8 bg-stone-700" />
        </div>
        
        {/* Main Heading */}
        <h2 className="font-serif text-4xl md:text-5xl lg:text-7xl text-white font-medium mb-8 leading-[1.1]">
          Ready to Elevate <br className="hidden sm:block" />
          <span className="italic text-stone-400">Your Space?</span>
        </h2>
        
        {/* Description */}
        <p className="text-stone-400 text-sm md:text-lg max-w-2xl mx-auto mb-12 font-sans font-light leading-relaxed">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-5 md:gap-6">
          <Link
            to="/contact"
            className="group relative inline-flex items-center justify-center gap-3 px-10 py-5 bg-white text-stone-900 rounded-sm overflow-hidden w-full sm:w-auto transition-all duration-300 shadow-xl"
          >
          ...
          <Link
            to="/materials"
            className="group inline-flex items-center justify-center px-10 py-5 bg-transparent border border-stone-700 hover:border-white text-stone-300 hover:text-white rounded-sm w-full sm:w-auto transition-all duration-500"
          >
