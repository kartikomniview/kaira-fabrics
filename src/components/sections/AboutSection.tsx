      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="max-w-xl mx-auto lg:mx-0 text-center lg:text-left">
            ...
            <h3 className={`font-serif text-3xl sm:text-4xl md:text-5xl text-stone-900 leading-[1.2] mb-8 transition-all duration-700 delay-100 ${isAboutVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              Kaira: The House of Sofa Fabrics
            </h3>

            <div className={`space-y-6 text-stone-500 text-sm sm:text-base leading-relaxed font-light transition-all duration-700 delay-200 ${isAboutVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}>
              <p>
