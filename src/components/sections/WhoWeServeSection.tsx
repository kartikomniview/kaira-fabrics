    ...
    >
      ...
      <div className={`relative max-w-7xl mx-auto px-6 lg:px-10 grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center transition-all duration-1000 ease-out ${
        ...
        <TiltCard className="md:col-span-1 md:row-span-2 bg-stone-900 rounded-2xl p-6 md:p-7 flex flex-col justify-between border border-stone-800 min-h-[280px]">
          ...
          <a
            href="https://wa.me/918589925111?text=Hi%2C%20I%27m%20a%20manufacturer%20interested%20in%20Kaira%20fabrics."
            target="_blank"
          ...
          <TiltCard className="bg-stone-900 rounded-2xl p-6 flex flex-col justify-between border border-stone-800">
            ...
            <a
              href="https://wa.me/918589925111?text=Hi%2C%20I%27m%20a%20designer%20interested%20in%20Kaira%20fabrics."
              target="_blank"
              rel="noopener noreferrer"
