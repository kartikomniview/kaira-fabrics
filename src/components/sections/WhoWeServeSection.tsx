...
const WHATSAPP_SVG = (
  <div className="flex items-center justify-center w-8 h-8 bg-white/10 hover:bg-[#25D366] transition-colors duration-300 text-white hover:text-white">
...
const cards = [
  {
    ...
    cta: 'Get a Quote',
    link: 'https://wa.me/918589925666?text=Hi%2C%20I%27m%20interested%20in%20a%20wholesale%20quote%20for%20my%20manufacturing%20business.',
  ...
  },
  {
    ...
    cta: 'Partner With Us',
    link: 'https://wa.me/918589925666?text=Hi%2C%20I%27m%20an%20interior%20designer%20looking%20to%20partner%20with%20Kaira.',
  ...
  },
  {
    ...
    link: 'https://wa.me/918589925666?text=Hi%2C%20I%20need%20help%20choosing%20fabrics%20for%20my%20home.',
            ...
            <motion.div key={card.title} variants={cardAnim} className="shrink-0 w-[72vw] sm:w-[55vw] snap-center md:w-auto md:h-full">
              ...
              >
                ...
                <div className="relative mt-auto p-4 md:p-6">
                  <h3 className="font-serif text-[1.4rem] md:text-[1.75rem] mb-2 leading-snug drop-shadow-md">
                    {card.titleParts.map((part, i) => (
                      <span key={i} className={part.primary ? 'text-primary' : 'text-white'}>
                        {part.text}
                      </span>
                    ))}
                  </h3>
                  <p className="text-white/80 text-[12px] md:text-[14px] leading-relaxed mb-4 md:mb-6 line-clamp-2 md:line-clamp-none">{card.description}</p>
                  <div className="flex items-center justify-between pt-4 md:pt-5 border-t border-white/20">
                    <span className="inline-flex items-center gap-2 bg-primary text-secondary-dark text-[10px] md:text-xs font-bold uppercase tracking-widest px-4 py-2 md:px-5 md:py-2.5 group-hover:gap-3.5 transition-all duration-300">
                      {card.cta}
